...
const translations: Record<Language, Record<string, unknown>> = {
    es: {
        ...
        config: {
            ...
            editProfileSubtitle: 'Aquí puedes cambiar tu foto, tu nombre y tu teléfono.',
            ...
            photoHint: 'Sube una imagen JPG, PNG o WEBP de hasta 2 MB o haz una foto con la cámara.',
    ...
    en: {
        ...
        config: {
            ...
            editProfileSubtitle: 'Here you can change your photo, name and phone number.',
            fullName: 'Full name',
            phone: 'Phone',
            ...
            photoHint: 'Upload a JPG, PNG or WEBP image up to 2 MB or take one with the camera.',
